...
L["SALoaded"] = "|cFFFF00FFSliceAdmiral %s loaded!!|r Options are under SliceAdmiral in the AddOns tab of the Game Menu Options menu"
...
L["energy/transp"] = "Energy Transparency"
